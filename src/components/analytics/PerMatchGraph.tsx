...
/**
 * Creates a line graph that displays the data for each match in a list of matches on the x axis, and
 * the data value generated by each of the plot functions on the y axis.
 */
